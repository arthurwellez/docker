...
<div id="wrapper">
    <div id="container">
        <div id="welcome">
            <h1>Welcome to Symfony 4 challenge</h1>
        </div>
        ...
        <div id="status">
            <p>
				...
				Your application is now ready.<br>You can start working.<br><br>
				I suggest you to install the following dependency :<br>
				<ul>
					<li><code>doctrine/annotations</code></li>
					<li><code>symfony/var-dumper</code></li>
					<li><code>symfony/orm-pack</code></li>
					<li><code>symfony/browser-kit</code></li>
					<li><code>symfony/phpunit-bridge</code></li>
					<li><code>sfriendsofsymfony/rest-bundle</code></li>
				</ul>
            </p>
        </div>
        ...
        <div id="next">
            ...
            <p>
                ...
                Read carefully README.MD before start to code :
                <a href="https://github.com/ma-residence/interview/blob/master/README.md">
                    Lets go !!!
                </a>
            </p>
        </div>
    ...
    <div id="comment">
        <p>
            It is a good start, your project is initialize and suggestion of dependency to install, good luck !
        </p>
    </div>
</div>
</body>
